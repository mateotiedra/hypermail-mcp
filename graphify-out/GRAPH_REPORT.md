# Graph Report - hyper-email-mcp-0  (2026-07-09)

## Corpus Check
- 77 files · ~44,571 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 681 nodes · 1568 edges · 38 communities (34 shown, 4 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9dd150d6`
...
Cohesion: 0.06
Nodes (22): ParsedPayload, GmailProvider, ImapProvider, OutlookProvider, AttachmentContent, AttachmentInput, CompleteAddAccountInput, CompleteAddAccountResult (+14 more)

### Community 1 - "Community 1"
Cohesion: 0.19
Nodes (16): htmlToMarkdown(), selectBody(), turndown, collectCandidatesForAccount(), compareNewEmailOutputOldestFirst(), compareTimestamp(), effectiveReceivedAt(), formatNewEmail() (+8 more)
...
Cohesion: 0.16
Nodes (15): convertInlineImages(), addAttachmentToDraft(), buildDraftFromReference(), hasMeaningfulHtmlTag(), isTextBody(), markRead(), moveEmail(), normalizeDraftBody() (+7 more)
...
Cohesion: 0.08
Nodes (41): envRaw(), loadConfig(), optionalEnvString(), parsePositiveInteger(), parseStringArray(), parseTransportEnv(), resolveDebugLogging(), resolveHttpConfig() (+33 more)

### Community 6 - "Community 6"
Cohesion: 0.07
Nodes (26): GmailProviderOptions, OutlookProviderOptions, BuildRegistryOptions, AccountStore, compareTimestamp(), delay(), isAlreadyDelivered(), mergeNewEmailCheckpoints() (+18 more)
...
Cohesion: 0.12
Nodes (19): GraphAttachment, GraphMessage, FULL_MESSAGE_SELECT, getAttachmentMetadata(), getAttachmentValue(), getMessage(), graphErrorFields(), isStaleMessageIdError() (+11 more)
...
Cohesion: 0.15
Nodes (13): EmailProvider, ProviderId, registerComposeTools(), EditDraftArgs, editDraftSchema, SendEmailArgs, sendEmailSchema, account (+5 more)

### Community 14 - "Community 14"
Cohesion: 0.22
Nodes (14): ResolvedTools, accountFullOutputSchema, accountSummaryOutputSchema, applyExactTextEdit(), ComposeBodyInput, errMsg(), fail(), folderInfoOutputSchema (+6 more)
...
Cohesion: 0.20
Nodes (11): registerAccountTools(), Handler, registerHandlers(), secretAccount, tools, registerBrowseTools(), registerFolderTools(), registerTools() (+3 more)

### Community 31 - "Community 31"
Cohesion: 0.18
Nodes (11): clampLimit(), GraphFolder, GraphRecipient, InlineAttachment, mapFolder(), mapRecipient(), mapSummary(), toRecipient() (+3 more)

### Community 33 - "Community 33"
Cohesion: 0.35
Nodes (8): Registry, Logger, markdownToHtml(), RegisterToolsOptions, buildStyleAttr(), composeBody(), escapeHtml(), isSuspiciousPlainTextHtml()

### Community 34 - "Community 34"
Cohesion: 0.43
Nodes (6): DeviceCodeBegin, createFolder(), deleteFolder(), listFolders(), renameFolder(), PendingFlow

### Community 36 - "Community 36"
Cohesion: 0.43
Nodes (6): BodyEditExpectation, bodyEditPersisted(), delay(), EDIT_DRAFT_VERIFY_DELAYS_MS, normalizeDraftBody(), readDraftWithVerifiedBody()

### Community 37 - "Community 37"
Cohesion: 0.40
Nodes (5): CreateLoggerOptions, LogFields, noopLogger, sanitizeFields(), sanitizeValue()

## Knowledge Gaps
- **145 isolated node(s):** `Why`, `Claude Desktop / Claude Code`, `As a hosted HTTP server`, `Docker`, `Development` (+140 more)
...
- **Why does `AccountRecord` connect `Community 0` to `Community 1`, `Community 2`, `Community 34`, `Community 4`, `Community 3`, `Community 6`, `Community 36`, `Community 10`, `Community 11`, `Community 13`, `Community 14`, `Community 15`, `Community 30`?**
  _High betweenness centrality (0.214) - this node is a cross-community bridge._
- **Why does `AccountStore` connect `Community 6` to `Community 0`, `Community 1`, `Community 2`, `Community 34`, `Community 4`, `Community 5`, `Community 33`, `Community 10`, `Community 13`, `Community 14`, `Community 15`, `Community 30`?**
