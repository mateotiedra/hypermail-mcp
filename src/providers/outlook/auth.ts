 ...
 * HYPERMAIL_OUTLOOK_CLIENT_ID for their own Entra app registrations.
 */
...
//   Operators should set HYPERMAIL_OUTLOOK_CLIENT_ID to a client they control for production.
            ...
            reject(
              new Error(
                "Microsoft device-code endpoint returned no code. " +
                  "Check HYPERMAIL_OUTLOOK_CLIENT_ID is a valid Azure Entra public-client application.",
              ),
            );
            return;
          }
